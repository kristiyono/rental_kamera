...
if(isset($_POST['submit'])){
	...
	$todate=$_POST['todate'];
	$driver=$_POST['photografer'];
	$vid=$_POST['vid'];
	$pickup=$_POST['pickup'];
//cek
$sql 	= "SELECT kode_booking FROM cek_booking WHERE tgl_booking between '$fromdate' AND '$todate' AND id_kamera='$vid' AND status!='Cancel'";
