									...
									<div class="form-group">
										<div class="col-sm-3">
											<div class="checkbox checkbox-inline">
												...
												<label for="airconditioner"> Flash Eksternal </label>
											</div>
										</div>
										...
										<div class="col-sm-3">
											<div class="checkbox checkbox-inline">
												...
												<label for="powerdoorlocks"> Lensa Kamera </label>
											</div>
										</div>
										...
										<div class="col-sm-3">
											<div class="checkbox checkbox-inline">
												...
												<label for="antilockbrakingsys"> Penutup Lensa Kamera</label>
											</div>
										</div>
										<div class="col-sm-3">
											<div class="checkbox checkbox-inline">
												<input type="checkbox" id="brakeassist" name="brakeassist" value="1">
												<label for="brakeassist"> Kartu Memori </label>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-sm-3">
											<div class="checkbox checkbox-inline">
												...
												<label for="inlineCheckbox5"> Baterai </label>
											</div>
										</div>
										<div class="col-sm-3">
											<div class="checkbox checkbox-inline">
												<input type="checkbox" id="driverairbag" name="driverairbag" value="1">
												<label for="driverairbag">Tripod</label>
											</div>
										</div>
										<div class="col-sm-3">
											<div class="checkbox checkbox-inline">
												<input type="checkbox" id="passengerairbag" name="passengerairbag" value="1">
												<label for="passengerairbag"> Kit Pembersih </label>
											</div>
										</div>
										<div class="col-sm-3">
											<div class="checkbox checkbox-inline">
												<input type="checkbox" id="powerwindow" name="powerwindow" value="1">
												<label for="powerwindow"> Shutter Release </label>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-sm-3">
											<div class="checkbox checkbox-inline">
												...
												<label for="cdplayer"> Filter </label>
											</div>
										</div>
										<div class="col-sm-3">
											<div class="checkbox h checkbox-inline">
												<input type="checkbox" id="centrallocking" name="centrallocking" value="1">
												<label for="centrallocking">Vertikal Grip</label>
											</div>
										</div>
										<div class="col-sm-3">
											<div class="checkbox checkbox-inline">
												<input type="checkbox" id="crashcensor" name="crashcensor" value="1">
												<label for="crashcensor"> Tas Kamera </label>
											</div>
										</div>
										<!-- <div class="col-sm-3">
											<div class="checkbox checkbox-inline">
