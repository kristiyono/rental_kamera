									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												...
												<input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($result['nama_kamera']);?>" required>
											</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<input type="text" name="nopol" class="form-control" value=" required>
											</div> -->
										</div>
										...
										<div class="form-group">
											<div class="col-sm-3">
												...
												{?>
													<div class="checkbox checkbox-inline">
														...
														<label for="inlineCheckbox1"> Flash Eksternal </label>
													</div>
												<?php } else { ?>
													<div class="checkbox checkbox-inline">
														<input type="checkbox" id="inlineCheckbox1" name="airconditioner" value="1">
														<label for="inlineCheckbox1"> Flask Eksternal </label>
													</div>
												<?php } ?>
											</div>
											<div class="col-sm-3">
												...
												{?>
													<div class="checkbox checkbox-inline">
														...
														<label for="inlineCheckbox2"> Lensa Kamera </label>
													</div>
												<?php } else {?>
											...
											{?>
												<div class="checkbox checkbox-inline">
													...
													<label for="inlineCheckbox3"> Penutup Lensa Kamera </label>
												</div>
											<?php } else {?>
												<div class="checkbox checkbox-inline">
											...
											{?>
												<div class="checkbox checkbox-inline">
													...
													<label for="inlineCheckbox3"> Kartu Memori </label>
												</div>
											<?php } else {?>
												<div class="checkbox checkbox-inline">
									...
									<div class="form-group">
										...
										{?>
											<div class="checkbox checkbox-inline">
												...
												<label for="inlineCheckbox1"> Baterai </label>
											</div>
										<?php } else {?>
											<div class="checkbox checkbox-inline">
										...
										{?>
											<div class="checkbox checkbox-inline">
												...
												<label for="inlineCheckbox2">Tripod</label>
											</div>
										<?php } else { ?>
											<div class="checkbox checkbox-inline">
										...
										{?>
											<div class="checkbox checkbox-inline">
												...
												<label for="inlineCheckbox3"> Kit Pembersih </label>
											</div>
										<?php } else { ?>
											<div class="checkbox checkbox-inline">
										...
										{?>
											<div class="checkbox checkbox-inline">
												...
												<label for="inlineCheckbox3"> Shutter Release </label>
											</div>
										<?php } else { ?>
											<div class="checkbox checkbox-inline">
									...
									<div class="form-group">
										...
										{?>
											<div class="checkbox checkbox-inline">
												...
												<label for="inlineCheckbox1"> Filter </label>
											</div>
										<?php } else {?>
											<div class="checkbox checkbox-inline">
										...
										{?>
											<div class="checkbox  checkbox-inline">
												...
												<label for="inlineCheckbox2">Vertikal Grip</label>
											</div>
										<?php } else { ?>
											<div class="checkbox checkbox-success checkbox-inline">
										...
										{?>
											<div class="checkbox checkbox-inline">
												...
												<label for="inlineCheckbox3"> Tas Kamera </label>
											</div>
										<?php } else {?>
											<div class="checkbox checkbox-inline">
