...
$sql="UPDATE kamera SET nama_kamera='$vehicletitle',id_merek='$brand',deskripsi='$vehicleoverview',harga='$priceperday',bb='$fueltype',tahun='$modelyear',
	...
	CDPlayer='$cdplayer',CentralLocking='$centrallocking',CrashSensor='$crashcensor',LeatherSeats='$leatherseats' where id_kamera='$id'";
