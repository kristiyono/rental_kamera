      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Penyewaan Kamera Terpercaya</h1>
            <p>Kami Punya beberapa pilihan Kamera terpopuler untuk anda. </p>
    ...
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Untuk Melihat Kamera</a></li>
        </ul>
      </div>
